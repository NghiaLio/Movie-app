...
class _registerScreenState extends State<registerScreen> {
  ...
  void register() async {
    ...
    if (checkMail && password.length >= 6 && name.length >= 4) {
      ...
      final x = await context.read<Authcubit>().register(name, email, password);

      if (x == null) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text('Email is exists', style: TextStyle(fontSize: 16))));
        setState(() {
          isLoading = false;
        });
      } else {
              ...
              Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    width:
                        size.width > 600 ? size.width * 0.04 : size.width * 0.1,
                    height:
                        size.width > 600 ? size.width * 0.04 : size.width * 0.1,
